...
public:
    ...
    std::string convertToHexStr(std::vector<unsigned char> bytes);

    std::vector<unsigned char> padToBlockSize(const std::vector<unsigned char>& data, size_t blockSize);

    std::vector<unsigned char> stringToBytes(const std::string& str);

    std::vector<std::vector<unsigned char>> divideIntoBlocks(const std::vector<unsigned char>& data, size_t blockSize);

    std::string bytesToString(const std::vector<unsigned char>& data);

    unsigned char* convertToHexArray(std::vector<unsigned char> bytes);
